...
class SettingsSeeder extends Seeder
{
    ...
    public function getItems()
    {
        return [
            ...
            ["type" => "plugin", "space" => "stripe", "name" => "publishable_key", "value" => "pk_test_YOUR_KEY_HERE", "json" => 0],
            ["type" => "plugin", "space" => "stripe", "name" => "secret_key", "value" => "sk_test_YOUR_KEY_HERE", "json" => 0],
